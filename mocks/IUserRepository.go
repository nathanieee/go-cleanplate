...
func (_m *IUserRepository) UpdatePassword(id uuid.UUID, password string) (*models.User, error) {
	...
	var r0 *models.User
	var r1 error
	if rf, ok := ret.Get(0).(func(uuid.UUID, string) (*models.User, error)); ok {
		return rf(id, password)
	}
	if rf, ok := ret.Get(0).(func(uuid.UUID, string) *models.User); ok {
		r0 = rf(id, password)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.User)
